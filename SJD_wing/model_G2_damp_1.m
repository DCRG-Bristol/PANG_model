function Y = model_G2_damp_1(X)
%% Title section - First damping ratio versus wing root pitch angles and EI, GJ, Sxx, Szz (G2 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G2 test (i.e., ground vibration test)
* The model computes the 1st damping ratio (OOP bending) as a function of uncertain variables (i.e., EI, GJ, Sxx, Szz)
...
--------------------------------------------------------
Output:
* Y: 1st damping ratio corresponding to the different wing root angles (the angles arranged in increasing order of magnitude)
    * Y(1)      :1st damping ratio at the smallest root angle (Hz)
    * Y(2)      :1st damping ratio at the 2nd smallest root angle (Hz)
    ...
    * Y(6)      :1st damping ratio at the largest root angle (Hz)
--------------------------------------------------------
%}
%%
...
[Y] = G2_damp_1(run, angl, 'EI', X(1), 'GJ', X(2), 'Sxx', X(3), 'Szz', X(4));
