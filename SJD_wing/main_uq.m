...
%% 8.1. Surrogates and parameter sweeps for the 1st damping ratio (OOP bending) as a function of EI, GJ, Sxx, Szz (G2 test)
...
plotsfolderName = 'damp_1_g2_uq'; 
mkdir(plotsfolderName)

% Description of the physical model for UQLab
ModelOpts.mFile = 'model_G2_damp_1';
ModelOpts.isVectorized = false;
myModel = uq_createModel(ModelOpts);
...
fprintf('Total surrogate building time: %.4f seconds\n', totalTime);
elementToSave = surrogates;
save(fullfile(plotsfolderName, 'surrogates_damp_1_g2.mat'), 'elementToSave'); % save the surrogate
tic;
...
%% 10.1. Surrogates and parameter sweeps for the 3rd modal damping ratio (2nd OOP bending) as a function of EI, GJ, Sxx, Szz (G2 test)
...
plotsfolderName = 'damp_3_g2_uq'; 
mkdir(plotsfolderName)

% Description of the physical model for UQLab
ModelOpts.mFile = 'model_G2_damp_3';
ModelOpts.isVectorized = false;
myModel = uq_createModel(ModelOpts);
...
% Plots generator for parameter sweeps for the uncertain variables
inputs_name = ["EI scaling factor", "GJ scaling factor", "Sxx scaling factor", "Szz scaling factor"];  % list of the names of the uncertain variables
outputs_name = ["3rd damp.ratio at 0deg", "3rd damp.ratio at 10deg", "3rd damp.ratio at 20deg", "3rd damp.ratio at 30deg", "3rd damp.ratio at 60deg", "3rd damp.ratio at 90deg"]; % list of the names of the QIs
N_outputs = length(outputs_name);             % number of quantities of interest (QIs)
descriptive_title_for_plots = sprintf('%s surrogate', MetaOpts.MetaType);
N_eval = 100;                                                        % number of discretisation points for each uncertain variable (for plots)
plotsfolderName = 'damp_3_g2_uq';   
...
fprintf('Total surrogate building time: %.4f seconds\n', totalTime);
elementToSave = surrogates;
save(fullfile(plotsfolderName, 'surrogates_damp_3_g2.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, [], [], []); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 11.1. Surrogates and parameter sweeps for the 4th modal damping ratio (torsion) as a function of EI, GJ, Sxx, Szz (G2 test)
...
plotsfolderName = 'damp_4_g2_uq'; 
mkdir(plotsfolderName)

% Description of the physical model for UQLab
ModelOpts.mFile = 'model_G2_damp_4';
ModelOpts.isVectorized = false;
myModel = uq_createModel(ModelOpts);
...
% Plots generator for parameter sweeps for the uncertain variables
inputs_name = ["EI scaling factor", "GJ scaling factor", "Sxx scaling factor", "Szz scaling factor"];  % list of the names of the uncertain variables
outputs_name = ["4th damp.ratio at 0deg", "4th damp.ratio at 10deg", "4th damp.ratio at 20deg", "4th damp.ratio at 30deg", "4th damp.ratio at 60deg", "4th damp.ratio at 90deg"]; % list of the names of the QIs
N_outputs = length(outputs_name);             % number of quantities of interest (QIs)
descriptive_title_for_plots = sprintf('%s surrogate', MetaOpts.MetaType);
N_eval = 100;                                                        % number of discretisation points for each uncertain variable (for plots)
plotsfolderName = 'damp_4_g2_uq';   
...
fprintf('Total surrogate building time: %.4f seconds\n', totalTime);
elementToSave = surrogates;
save(fullfile(plotsfolderName, 'surrogates_damp_4_g2.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, [], [], []); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
load('groundTests\testData\SJD_groundTestData.mat', 'exprData');
experimental_data_set = exprData{1, 3}.frequencies(1, :);   
load('GVT_freq_lower_and_upper_bounds.mat', 'oop1_mode_freq_lb', 'oop1_mode_freq_ub')
...
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, oop1_mode_freq_lb, oop1_mode_freq_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 12.1. Surrogates and parameter sweeps for the 1st damping ratio (OOP bending) as a function of EI only (G2 test)
...
plotsfolderName = 'damp_1_g2_dim_red_uq'; 
mkdir(plotsfolderName)
...
flag_test_for_mean_and_sigma = false;
flag_test_set = true;           % will a test set be generated for further surrogate validation?   
load('GVT_damp_lower_and_upper_bounds.mat', 'oop1_mode_damp_lb', 'oop1_mode_damp_ub')
experimental_data_set = oop1_mode_damp_lb+(oop1_mode_damp_ub-oop1_mode_damp_lb)/2;
...
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, oop1_mode_damp_lb, oop1_mode_damp_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
load('groundTests\testData\SJD_groundTestData.mat', 'exprData');
experimental_data_set = exprData{1, 3}.frequencies(2, :); 
load('GVT_freq_lower_and_upper_bounds.mat', 'ip1_mode_freq_lb', 'ip1_mode_freq_ub')
...
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, ip1_mode_freq_lb, ip1_mode_freq_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
load('groundTests\testData\SJD_groundTestData.mat', 'exprData');
experimental_data_set = exprData{1, 3}.frequencies(3, :); 
load('GVT_freq_lower_and_upper_bounds.mat', 'oop2_mode_freq_lb', 'oop2_mode_freq_ub')
...
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, oop2_mode_freq_lb, oop2_mode_freq_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 14.1. Surrogates and parameter sweeps for the 3rd modal damping ratio (2nd OOP bending) as a function of EI only (G2 test)
...
plotsfolderName = 'damp_3_g2_dim_red_uq'; 
mkdir(plotsfolderName)

% Description of the physical model for UQLab
ModelOpts.mFile = 'model_G2_damp_3_dim_red';
ModelOpts.isVectorized = false;
myModel = uq_createModel(ModelOpts);
...
flag_test_for_mean_and_sigma = false;
flag_test_set = true;           % will a test set be generated for further surrogate validation?
load('GVT_damp_lower_and_upper_bounds.mat', 'oop2_mode_damp_lb', 'oop2_mode_damp_ub')
experimental_data_set = oop2_mode_damp_lb+(oop2_mode_damp_ub-oop2_mode_damp_lb)/2;
...
fprintf('Total surrogate building time: %.4f seconds\n', totalTime);
elementToSave = surrogates;
save(fullfile(plotsfolderName, 'surrogates_damp_3_g2_dim_red.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, oop2_mode_damp_lb, oop2_mode_damp_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 14.2. Surrogates and parameter sweeps for the 3rd modal damping ratio (2nd OOP bending) as a function of EI only (G2 test) - no outliers
...
plotsfolderName = 'damp_3_g2_no_outliers_dim_red_uq'; 
mkdir(plotsfolderName)
...
flag_test_for_mean_and_sigma = false;
flag_test_set = true;           % will a test set be generated for further surrogate validation?
load('GVT_damp_no_outliers_lower_and_upper_bounds.mat', 'oop2_mode_damp_no_outliers_lb', 'oop2_mode_damp_no_outliers_ub')
experimental_data_set = oop2_mode_damp_no_outliers_lb+(oop2_mode_damp_no_outliers_ub-oop2_mode_damp_no_outliers_lb)/2;
...
save(fullfile(plotsfolderName, 'surrogates_damp_3_g2_dim_red.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, oop2_mode_damp_no_outliers_lb, oop2_mode_damp_no_outliers_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 15.1. Surrogates and parameter sweeps for the 4th modal damping ratio (torsion) as a function of GJ, Sxx, Szz only (G2 test)
...
plotsfolderName = 'damp_4_g2_dim_red_uq'; 
mkdir(plotsfolderName)

% Description of the physical model for UQLab
ModelOpts.mFile = 'model_G2_damp_4_dim_red';
ModelOpts.isVectorized = false;
myModel = uq_createModel(ModelOpts);
...
flag_test_for_mean_and_sigma = false;
flag_test_set = true;           % will a test set be generated for further surrogate validation?
load('GVT_damp_lower_and_upper_bounds.mat', 'tor1_mode_damp_lb', 'tor1_mode_damp_ub')
experimental_data_set = tor1_mode_damp_lb+(tor1_mode_damp_ub-tor1_mode_damp_lb)/2;
...
fprintf('Total surrogate building time: %.4f seconds\n', totalTime);
elementToSave = surrogates;
save(fullfile(plotsfolderName, 'surrogates_damp_4_g2_dim_red.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, tor1_mode_damp_lb, tor1_mode_damp_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 15.2. Surrogates and parameter sweeps for the 4th modal damping ratio (torsion) as a function of GJ, Sxx, Szz only (G2 test) - no outliers
...
plotsfolderName = 'damp_4_g2_no_outliers_dim_red_uq'; 
mkdir(plotsfolderName)
...
flag_test_for_mean_and_sigma = false;
flag_test_set = true;           % will a test set be generated for further surrogate validation?
load('GVT_damp_no_outliers_lower_and_upper_bounds.mat', 'tor1_mode_damp_no_outliers_lb', 'tor1_mode_damp_no_outliers_ub')
experimental_data_set = tor1_mode_damp_no_outliers_lb+(tor1_mode_damp_no_outliers_ub-tor1_mode_damp_no_outliers_lb)/2;
...
save(fullfile(plotsfolderName, 'surrogates_damp_4_g2_dim_red.mat'), 'elementToSave'); % save the surrogate
tic;
uncertain_variables_exploration(elementToSave, inputs_name, outputs_name, descriptive_title_for_plots, N_eval, seed, plotsfolderName, experimental_data_set, tor1_mode_damp_no_outliers_lb, tor1_mode_damp_no_outliers_ub); % plots generator using the surrogates 
totalTime = toc;
fprintf('Total design space exploration time: %.4f seconds\n', totalTime);
...
%% 23. Randomise-then-optimise - Model update via least-squares error (LSE) optimisation (all data considered for calibration) - shifted using alpha=0, no strain uncertainty
% the uncertain variables to be updated are (x1:=EI, x2:=GJ, x3:=Sxx=Szz)
lb = [0.8, 0.8, 0.8]; 
ub = [1.2, 1.2, 1.2];
N_variables = length(ub);
...
for ii = 1:N_samples
    f1 = @(x) surrogates_model_update_objective_function_mod_lse_rand(x, ...
    ...
    true_objective_f_val_opt(ii) = model_update_objective_function_mod_lse_rand(x_opt_lse(ii, :), ...
        rand_data_model_G1_1_tip_deflection_LE(ii, :), rand_data_model_G1_1_tip_deflection_TE(ii, :), rand_data_model_G1_2_tip_deflection_LE(ii, :), ...
...
function F_val = model_update_objective_function_mod_lse_rand(x, ...
...
function F_val = surrogates_model_update_objective_function_mod_lse_rand(x, ...
        rand_data_model_G1_1_tip_deflection_LE, rand_data_model_G1_1_tip_deflection_TE, rand_data_model_G1_2_tip_deflection_LE, ...
        rand_data_model_G1_2_tip_deflection_TE, rand_data_model_G2_frq_1, rand_data_model_G2_frq_2, rand_data_model_G2_frq_3, rand_data_model_G2_frq_4)
    load('groundTests\testData\SJD_groundTestData.mat', 'exprData');
