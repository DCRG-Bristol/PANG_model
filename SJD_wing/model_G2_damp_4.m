function Y = model_G2_damp_4(X)
%% Title section - Fourth damping ratio versus wing root pitch angles and EI, GJ, Sxx, Szz (G2 test)
%{
--------------------------------------------------------
Comments:
...
[Y] = G2_damp_4(run, angl, 'EI', X(1), 'GJ', X(2), 'Sxx', X(3), 'Szz', X(4));
