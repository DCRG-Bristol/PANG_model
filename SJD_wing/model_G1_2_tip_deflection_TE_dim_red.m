function Y = model_G1_2_tip_deflection_TE_dim_red(X)
%% Title section - Tip deflections versus wing root pitch angles and EI (G1_1 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G1_2 test (i.e., ground static test with wing tip weight)
* The model computes the tip deflection (trailing edge (TE)) as a function of uncertain variables (i.e., EI)
