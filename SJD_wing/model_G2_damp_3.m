function Y = model_G2_damp_3(X)
%% Title section - Third damping ratio versus wing root pitch angles and EI, GJ, Sxx, Szz (G2 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G2 test (i.e., ground vibration test)
* The model computes the 3rd damping ratio (OOP2 bending) as a function of uncertain variables (i.e., EI, GJ, Sxx, Szz)
...
[Y] = G2_damp_3(run, angl, 'EI', X(1), 'GJ', X(2), 'Sxx', X(3), 'Szz', X(4));
