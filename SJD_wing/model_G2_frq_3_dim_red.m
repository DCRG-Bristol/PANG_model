function Y = model_G2_frq_3_dim_red(X)
%% Title section - Third frequency versus wing root pitch angles and EI (G2 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G2 test (i.e., ground vibration test)
* The model computes the 3rd modal frequency (2nd OOP bending) as a function of uncertain variables (i.e., EI)
...
[Y] = G2_frq_3(run, angl, 'EI', X(1), 'GJ', 1, 'Sxx', 1, 'Szz', 1);
