function Y = model_G1_2_tip_deflection_LE_dim_red(X)
%% Title section - Tip deflections versus wing root pitch angles and EI (G1_2 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G1_2 test (i.e., ground static test with wing tip weight)
* The model computes the tip deflection (leading edge (LE)) as a function of uncertain variables (i.e., EI)
...
[Y] = G1_2_tip_deflection(run, angl, 'EI', X(1), 'GJ', 1);
