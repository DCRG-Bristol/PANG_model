function Y = model_G1_2_beta_y(X)
...
* The model computes the strain (bending (beta_y)) as a function of uncertain variables (i.e., EI, GJ)
...
[Y] = G1_2_beta_y(run, angl, 'EI', X(1), 'GJ', X(2));
