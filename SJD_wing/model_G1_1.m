function Y = model_G1_1(X,angl)
%% Title section - Tip deflections and strains versus wing root pitch angles and EI, GJ (G1_1 test)
%{
--------------------------------------------------------
Comments:
...
[delta_LE, delta_TE, beta_y, beta_x] = G1_1(run, angl, 'EI', X(1), 'GJ', X(2));
