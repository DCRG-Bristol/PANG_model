function Y = model_G2_damp_1_dim_red(X)
%% Title section - First damping ratio versus wing root pitch angles and EI (G2 test)
%{
--------------------------------------------------------
Comments:
* This model refers to the G2 test (i.e., ground vibration test)
* The model computes the 1st damping ratio (OOP bending) as a function of uncertain variables (i.e., EI)
...
[Y] = G2_damp_1(run, angl, 'EI', X(1), 'GJ', 1, 'Sxx', 1, 'Szz', 1);
