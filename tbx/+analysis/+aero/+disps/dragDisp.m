function Disp = dragDisp(q,qt,p0,p,vy,vz)
...
if isempty(k1_1)
    k1_1 = project.aero.disps.odr_1.Drg_proj1(p);
    k1_2 = project.aero.disps.odr_2.Drg_proj1(p);
    k1_3 = project.aero.disps.odr_3.Drg_proj1(p);

    k2_1 = project.aero.disps.odr_1.Drg_proj2(p);
    k2_2 = project.aero.disps.odr_2.Drg_proj2(p);
    k2_3 = project.aero.disps.odr_3.Drg_proj2(p);
end
