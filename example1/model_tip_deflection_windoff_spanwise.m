function Y = model_tip_deflection_windoff_spanwise(X, P)
%% Title section - Wind-off spanwise deflections versus pitch angle and E
%{
--------------------------------------------------------
Comments:
* The model computes the wind-off spanwise deflection as a function of uncertain variables (i.e., E, G)
