function Y = model_tip_deflection_windon_spanwise(X, P)
%% Title section - Wind-on spanwise deflections versus airspeed and E, G
%{
--------------------------------------------------------
Comments:
* The model computes the wind-on spanwise deflection as a function of uncertain variables (i.e., E, G)
...
* Y: vector of quantities of interest (QIs)
    * Y(1)      : root LE displacement in z direction (OOP)
    ...
    * Y(50)     : tip LE displacement in z direction (OOP)
--------------------------------------------------------
%}
%%
...
[x, y, z] = run.getDisplField(q, xMesh ,'beamModel'); %get displacements at teh beam tip.. in the beam model frame
